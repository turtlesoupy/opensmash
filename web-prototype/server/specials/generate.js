...
Describe the recognizable action, prop details and materials, body and prop motion, visible beats, and any emitted fragments and their departure. Describe the intended result, not geometry fields or implementation code. Establish where a prop first appears or is retrieved, how the fighter handles it, and where emitted effects originate. If an unusual bodily origin is essential to the action or humor, make that intention explicit.
